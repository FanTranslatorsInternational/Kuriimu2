...
{
    class CfntState : ILoadFiles, ISaveFiles, IAddCharacters, IRemoveCharacters
    {
        private readonly CfntReader _reader = new();
        private readonly CfntWriter _writer = new();

        private CfntData _fontData;
