...
{
    class CteState : ILoadFiles, ISaveFiles, IImageFilePluginState
    {
        private readonly Cte _img = new();
        ...
        public async Task Load(IFileSystem fileSystem, UPath filePath, LoadContext loadContext)
        {
            ...
            _images = [new ImageFile(_img.Load(fileStream), CteSupport.GetEncodingDefinition())];
        }
