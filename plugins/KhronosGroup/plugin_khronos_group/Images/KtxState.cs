...
{
    class KtxState : ILoadFiles, ISaveFiles, IImageFilePluginState
    {
        private readonly Ktx _img = new();
        ...
        public async Task Load(IFileSystem fileSystem, UPath filePath, LoadContext loadContext)
        {
            ...
            _images = [new ImageFile(_img.Load(fileStream), KtxSupport.GetEncodingDefinition())];
        }
