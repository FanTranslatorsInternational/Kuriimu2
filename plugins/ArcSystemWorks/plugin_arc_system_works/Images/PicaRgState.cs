...
{
    class PicaRgState : ILoadFiles, ISaveFiles, IImageFilePluginState
    {
        private PicaRg _img = new();
        ...
        public async Task Load(IFileSystem fileSystem, UPath filePath, LoadContext loadContext)
        {
            ...
            _images = [new ImageFile(_img.Load(fileStream), PicaRgSupport.GetEncodingDefinition())];
        }
