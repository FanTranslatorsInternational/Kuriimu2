...
{
    class XnbState : ILoadFiles, ISaveFiles, IImageFilePluginState
    {
        private readonly Xnb _img = new();
        ...
        public async Task Load(IFileSystem fileSystem, UPath filePath, LoadContext loadContext)
        {
            ...
            _images = [new ImageFile(_img.Load(fileStream), XnbSupport.GetEncodingDefinition())];
        }
