...
namespace plugin_level5.Archives
{
    ...
    class Xfsa
    {
        ...
        public IReadOnlyList<ArchiveFileInfo> Load(Stream input)
        {
            ...
            var directoryEntries = ReadCompressedTableEntries<XfsaDirectoryEntry>(input,
            ...
            var entries = ReadCompressedTableEntries<XfsaFileEntry>(input,
        ...
        public void Save(Stream output, IReadOnlyList<ArchiveFileInfo> files, IProgressContext progress)
        {
            ...
            var castedFiles = files.Cast<XfsaArchiveFileInfo>();
        ...
        private void BuildTables(IEnumerable<XfsaArchiveFileInfo> files,
            out IList<XfsaDirectoryEntry> directoryEntries, out IList<uint> directoryHashes,
            out IList<XfsaArchiveFileInfo> fileEntries, out Stream nameStream)
        {
            ...
            var fileInfos = new List<XfsaArchiveFileInfo>();
            directoryEntries = new List<XfsaDirectoryEntry>();
            ...
            foreach (var fileGroup in groupedFiles)
            {
                ...
                var newDirectoryEntry = new XfsaDirectoryEntry
                {
