...
{
    class HtexState : ILoadFiles, ISaveFiles, IImageFilePluginState
    {
        private readonly Htex _img = new();
        ...
        public async Task Load(IFileSystem fileSystem, UPath filePath, LoadContext loadContext)
        {
            ...
            _images = [new ImageFile(_img.Load(fileStream), HtexSupport.GetEncodingDefinition())];
        }
