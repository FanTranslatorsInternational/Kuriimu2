...
{
    // TODO: Redo RawImageViewer
    //public partial class RawImageViewer : Form
    //{
    //    private readonly PluginLoader manager;
    ...
    //        foreach (var adapter in manager.GetAdapters<IColorEncodingAdapter>())
    ...
    //        var customSwizzle = manager.GetAdapters<IImageSwizzleAdapter>().FirstOrDefault(x => x.Name == "Custom");
