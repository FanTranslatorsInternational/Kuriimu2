...
namespace Kore.Managers.Plugins.FileManagement
{
    ...
    internal class FileLoader : IFileLoader
    {
        ...
        private IFilePlugin GetManualSelection(IEnumerable<IFilePlugin> allFilePlugins, IEnumerable<IFilePlugin> filteredFilePlugins, FileManager.ManualSelectionEventArgs.SelectionStatus status)
        {
