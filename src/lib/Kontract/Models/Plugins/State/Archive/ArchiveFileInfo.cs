...
namespace Kontract.Models.Plugins.State.Archive
{
    /// <summary>
    ...
    public class ArchiveFileInfo : IArchiveFileInfo
    {
        ...
        public ArchiveFileInfo(Stream fileData, string filePath, IKompressionConfiguration configuration, long decompressedSize) :
        ...
        /// <summary>
        /// Get the final stream of FileData. This is:
        ///     1. The compressed stream, if a compression is set, or
        ///     2. The decompressed stream, if a compression is set but compression was disabled for this operation, or
        ///     3. The original <see cref="FileData"/> stream.
        /// </summary>
        ...
        private long GetFileDataLength() => FileData?.Length ?? 0;
