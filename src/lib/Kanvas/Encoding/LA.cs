...
namespace Kanvas.Encoding
{
    ...
    /// </summary>
    public class La(int l, int a, string componentOrder, ByteOrder byteOrder = ByteOrder.LittleEndian, BitOrder bitOrder = BitOrder.MostSignificantBitFirst)
        : PixelEncoding(new LaPixelDescriptor(componentOrder, l, a), byteOrder, bitOrder)
    {
        /// <summary>
