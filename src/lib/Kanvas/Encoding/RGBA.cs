...
namespace Kanvas.Encoding
{
    ...
    /// </summary>
    public class Rgba(int r, int g, int b, int a, string componentOrder, ByteOrder byteOrder = ByteOrder.LittleEndian, BitOrder bitOrder = BitOrder.MostSignificantBitFirst)
        : PixelEncoding(new RgbaPixelDescriptor(componentOrder, r, g, b, a), byteOrder, bitOrder)
    {
        /// <summary>
