...
namespace Kanvas.Quantization.Models.Ditherer
{
    class ErrorDiffusionElement2
    {
        ...
        public ErrorDiffusionElement2(IList<Color> colors, int colorIndex, IDictionary<int, ColorComponentError> errors, IList<int> indices)
        {
            _colors = colors;
