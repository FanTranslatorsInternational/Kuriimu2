...
namespace Kompression.Implementations
{
    public class TalesOf01 : BaseLz
    {
        ...
        {
           return new NewOptimalParser(null,0,new BackwardLz77MatchFinder(0,0,0,0));
        }

        protected override IPatternMatchDecoder CreateDecoder()
        {
            return new TalesOf01Decoder();
        }

        public override string[] Names => new[] { "Tales Of Mode 0x01" };
    }
}
