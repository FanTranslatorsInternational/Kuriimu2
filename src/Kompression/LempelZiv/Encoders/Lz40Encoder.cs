...
namespace Kompression.LempelZiv.Encoders
{
    class Lz40Encoder:ILzEncoder
    {
        ...
        internal void WriteCompressedData(Stream input, Stream output, IList<LzMatch> lzResults)
        {
        ...
        private int WriteCompressedBlockToBuffer(LzMatch lzMatch, byte[] blockBuffer, int blockBufferLength, int bufferedBlocks)
        {
