...
namespace Kontract.Interfaces.Plugins.State.Image
{
    /// <summary>
    ...
    public abstract class BaseIndexedImageAdapter : BaseImageAdapter, IIndexedImageAdapter
    {
        ...
        protected abstract (Bitmap Image, IList<Color> Palette) Transcode(BitmapInfo bitmapInfo, EncodingInfo imageEncoding, EncodingInfo paletteEncoding, IKuriimuProgress progress);
        ...
        // TODO: Add possibilities of giving quantization information.
        public virtual Task<ImageTranscodeResult> TranscodeImage(BitmapInfo bitmapInfo, EncodingInfo imageEncoding, EncodingInfo paletteEncoding, IKuriimuProgress progress)
        {
            // Validity checks
        ...
        protected abstract Bitmap TranscodeWithPalette(IndexedBitmapInfo bitmapInfo, IList<Color> palette, IKuriimuProgress progress);

        /// <inheritdoc cref="IIndexedImageAdapter.SetPalette(IndexedBitmapInfo,IList{Color},IProgress{ProgressReport})"/>
        public virtual Task<ImageTranscodeResult> SetPalette(IndexedBitmapInfo bitmapInfo, IList<Color> palette, IKuriimuProgress progress)
        {
            // Validity checks
            if (bitmapInfo == null) throw new ArgumentNullException(nameof(bitmapInfo));
        ...
        public virtual Task<ImageTranscodeResult> SetColorInPalette(IndexedBitmapInfo bitmapInfo, int index, Color color, IKuriimuProgress progress)
        {
            // Validity checks
            if (bitmapInfo == null) throw new ArgumentNullException(nameof(bitmapInfo));
        ...
        public virtual Task<ImageTranscodeResult> SetIndexInImage(IndexedBitmapInfo indexInfo, Point pointInImg, int newIndex, IKuriimuProgress progress)
        {
            // Validity checks
