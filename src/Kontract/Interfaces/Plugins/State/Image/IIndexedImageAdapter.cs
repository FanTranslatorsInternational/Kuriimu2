...
namespace Kontract.Interfaces.Plugins.State.Image
{
    ...
    public interface IIndexedImageAdapter : IImageAdapter
    {
        ...
        Task<ImageTranscodeResult> TranscodeImage(BitmapInfo image, EncodingInfo imageEncoding, EncodingInfo paletteEncoding, IKuriimuProgress progress);
        ...
        Task<ImageTranscodeResult> SetPalette(IndexedBitmapInfo bitmapInfo, IList<Color> palette, IKuriimuProgress progress);
        ...
        Task<ImageTranscodeResult> SetColorInPalette(IndexedBitmapInfo bitmapInfo, int index, Color color, IKuriimuProgress progress);
        ...
        Task<ImageTranscodeResult> SetIndexInImage(IndexedBitmapInfo bitmapInfo, Point pointInImg, int newIndex, IKuriimuProgress progress);
