...
namespace Kontract.Interfaces.Plugins.State.Image
{
    ...
    public abstract class BaseImageAdapter : IImageAdapter
    {
        ...
        protected abstract Bitmap Transcode(BitmapInfo bitmapInfo, EncodingInfo imageEncoding, IKuriimuProgress progress);
        ...
        public virtual Task<ImageTranscodeResult> TranscodeImage(BitmapInfo bitmapInfo, EncodingInfo imageEncoding, IKuriimuProgress progress)
        {
            // Validity checks
