...
namespace Kuriimu2.EtoForms.Controls
{
    public class ProgressBarEx : Drawable
    {
        ...
        private Color _textColor = Themer.Instance.GetTheme().AltColor;
        private Color _progressColor = Themer.Instance.GetTheme().ProgressColor;
        private Color _borderColor = Themer.Instance.GetTheme().ProgressBorderColor;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // Draw background
            e.Graphics.FillRectangle(new SolidBrush(Themer.Instance.GetTheme().ProgressControlColor), controlRect);
